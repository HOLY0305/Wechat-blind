...
#### FR-06: 界面美化
- 设置页面 UI 重新设计，提升视觉体验（苹果风格）
- 添加应用图标（托盘图标、窗口图标）✓ 已完成
- 设置页面添加实时预览功能 ✓ 已完成（直接更新实际遮罩）

#### FR-07: 遮罩自定义
- 支持用户上传自定义遮罩图案（图片）
- 提供预设图案库（几何图案、渐变效果等）
- 遮罩图案透明度/位置可调
- 图案存储位置：%APPDATA%\WechatBlind\patterns\

#### FR-08: 设置实时预览
- 调整透明度/模糊度时实时显示效果 ✓ 已完成
- 通过 SettingsChanged 事件直接更新实际遮罩
